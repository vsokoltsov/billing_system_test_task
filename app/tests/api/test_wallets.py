...
@pytest.mark.asyncio
async def test_success_wallet_transfer(client, test_db):
...
@pytest.mark.asyncio
async def test_failed_wallet_transfer_amount_is_negative(client, test_db):
...
@pytest.mark.asyncio
async def test_failed_wallet_transfer_params_are_empty(client, test_db):
    """ Test failed wallet transfer (amount field is negative). """
...
@pytest.mark.asyncio
async def test_failed_wallet_transfer_wallets_are_equal(client, test_db):
