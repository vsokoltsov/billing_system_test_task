...
@pytest.mark.asyncio
async def test_failed_user_create_usecase_wallet_operation(test_db, wallet_operation_repository_mock):
...
@pytest.mark.asyncio
async def test_failed_user_create_usecase_user_retrieve(test_db, user_repository_mock, user_factory):
    """Test failed user create usecase. (wallet operation was not created)"""
